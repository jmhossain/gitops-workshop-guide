# GitOps Workshop Guide for **ACE on CP4I**
...
Inside the `ibm-ace-operator.yaml` file, you can change the MQ operator version as follows
```yaml
....
spec:
  ....
